...
def qa(
    ...
    no_dup_nextflow_svclustering_germline = qa_tasks.no_dup_nextflow_svclustering_germline(spark_jar)
    no_dup_nextflow_svclustering_somatic = qa_tasks.no_dup_nextflow_svclustering_somatic(spark_jar)
    ...
    [non_empty_tables, no_dup_gnomad_joint, no_dup_clinical, no_dup_nor_snv, no_dup_nor_snv_somatic, no_dup_nor_consequences,
     ...
     no_dup_variant_centric, no_dup_cnv_centric, no_dup_coverage_by_gene, no_dup_nextflow_svclustering_germline,
     no_dup_nextflow_svclustering_somatic, no_dup_nextflow_svclustering_parental_origin, same_list_nor_snv_nor_variants,
