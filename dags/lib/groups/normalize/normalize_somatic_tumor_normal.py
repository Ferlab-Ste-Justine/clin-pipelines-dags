...
def normalize_somatic_tumor_normal(
    ...
    snv_somatic = normalize.snv_somatic(batch_id, analysis_ids, BioinfoAnalysisCode.TNEBA.value, target_batch_types, spark_jar, skip(skip_all, skip_snv_somatic), detect_batch_type_task_id)
    ...
    coverage_by_gene = normalize.coverage_by_gene(batch_id, analysis_ids, BioinfoAnalysisCode.TNEBA.value, target_batch_types, spark_jar, skip(skip_all, skip_coverage_by_gene), detect_batch_type_task_id)
