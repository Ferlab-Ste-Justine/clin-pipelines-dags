...
def prepare(sequencing_ids: Set[str]) -> Dict[str, str]:
    ...
    from phenopackets.schema.v1 import base_pb2 as phenopacket
    from phenopackets.schema.v1.phenopackets_pb2 import Phenopacket, Family
    ...
    sex_mapping: Dict[str, phenopacket.Sex] = {
        'Male': phenopacket.MALE,
        'Female': phenopacket.FEMALE,
        'unknown': phenopacket.UNKNOWN_SEX,
        'other': phenopacket.OTHER_SEX
    }

    # Mapping enriched_clinical affected_status_code to phenopacket affected status enum
    affected_mapping: Dict[str, phenopacket.Pedigree.Person.AffectedStatus] = {
        "affected": phenopacket.Pedigree.Person.AFFECTED,
        "not_affected": phenopacket.Pedigree.Person.UNAFFECTED,
        "unknown": phenopacket.Pedigree.Person.MISSING
    }
    ...
    for _, proband_row in probands_df.iterrows():
        ...
        proband = phenopacket.Individual(
        ...
        phenotypic_features = [phenopacket.PhenotypicFeature(
            type=phenopacket.OntologyClass(id=sign["id"], label=sign["name"])
        ...
        persons = [phenopacket.Pedigree.Person(
